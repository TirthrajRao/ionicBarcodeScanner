...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>Ionic 4 Barcode Scanner</ion-title>\n  </ion-toolbar>\n</ion-header>\n \n<ion-content padding>\n  \n<h6>Click Button To Scan</h6>\n \n \n<button ion-button round (click)=\"scanCode()\">Scan Code</button>\n \n<div *ngIf=\"scannedData\">\n  <p>Scanned Code Text : <b>{{scannedData['text']}}</b></p>\n  <p>Scanned Code Format : <b>{{scannedData['format']}}</b></p>\n</div>\n\n<div style=\"padding-top: 20px\">\n<h6>Enter text to generate Code!</h6> \n<ion-input [(ngModel)]=\"code\" type=\"text\" placeholder=\"Enter text here\"></ion-input>\n\n<button ion-button block (click)=\"process();\">Generate</button>\n<p *ngIf=\"msg\" style=\"color: red;\">{{msg}}</p>\n\n<img *ngIf=\"displayQrCode()\" [src]=\"generated\" style=\"padding-top: 20px\" />\n</div>\n</ion-content>"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.displayQrCode = function () {
    ...
    AppComponent.prototype.process = function () {
        var qrcode = qrcode__WEBPACK_IMPORTED_MODULE_1___default.a;
        var self = this;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            entryComponents: [],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"]],
            providers: [
...
module.exports = __webpack_require__(/*! /var/www/html/Bhavik/IonicBarcodeScanner/src/main.ts */"./src/main.ts");
